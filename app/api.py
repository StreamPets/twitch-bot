...
class ApiService:
  ...
  def announce_join(self, channel_name: str, user_id: str, username: str) -> None:
    url = f"{self.api_url}/channels/{channel_name}/users"
  ...
  def announce_part(self, channel_name: str, user_id: str) -> None:
    url = f"{self.api_url}/channels/{channel_name}/users/{user_id}"
    requests.delete(url)
  ...
  def announce_jump(self, channel_name: str, user_id: str) -> None:
    url = f"{self.api_url}/channels/{channel_name}/users/{user_id}/JUMP"
    requests.post(url)
